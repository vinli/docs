...
- Similarly, a rule will never fire an event if it contains two disjoint parametric boundaries for the same vehicle parameter. For example, "RPM greater than 3500" and "RPM less than 2000" will forever remain in the "unevaluated" state.
